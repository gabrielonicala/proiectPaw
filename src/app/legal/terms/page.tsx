...
export default function TermsPage() {
  ...
  useEffect(() => {
    ...
    const initTimeout = setTimeout(() => {
      ...
      const loadIubendaContent = () => {
        ...
        anchor.href = 'https://www.iubenda.com/terms-and-conditions/70554621';
        anchor.className = 'iubenda-black iubenda-noiframe iubenda-embed iubenda-noiframe iub-body-embed';
        anchor.title = 'Terms and Conditions';
        anchor.textContent = 'Terms and Conditions';
    ...
    const checkContent = () => {
      ...
      const anchorReplaced = !anchor || !container.innerHTML.includes('Terms and Conditions</a>');
  ...
  return (
    <div className={`min-h-screen bg-white transition-opacity duration-300 ${contentLoaded ? 'opacity-100' : 'opacity-0'}`}>
      {/* Allow text selection on terms page */}
